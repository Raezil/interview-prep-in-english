- **Tell me about yourself:**
	- I’m Kamil, open source developer that build many projects in golang. I've built Thunder, a minimalist framework that transforms gRPC services into both REST and GraphQL, It reached 100 stars on github.
	- Recently I’ve been heads-down helping push the Universal Tool Calling Protocol (UTCP) forward—spec work plus the official Go implementation under the UTCP org. It’s a standard that lets AI agents call tools directly over native transports.
